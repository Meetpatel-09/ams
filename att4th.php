                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="att5p.php?id=<?php echo $aid ?>" type="submit" class="btn btn-success" style="margin-top: 15px;">P</a> <a href="att5a.php?id=<?php echo $aid ?>" type="submit" class="btn btn-danger" style="margin-top: 15px;">A</a>
                                    </td>
                                </tr>
                                <?php
                                }                       
